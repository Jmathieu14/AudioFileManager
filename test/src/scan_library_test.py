...
class GetGenreFromAudioFileTest(unittest.TestCase):
    ...
    def test_returns_expected_genre_from_db(self, audio_file_mock):
        ...
        database.save_item_to_database_if_does_not_exist(
            constants.existing_genre)
        audio_file_mock.metadata = constants.solo_skrillex_audio_file
        actual_genre = get_genre_from_audio_file(audio_file_mock)
        self.assertEqual(constants.existing_genre, actual_genre)
    ...
    def test_creates_genre_and_adds_to_db(self, audio_file_mock):
        ...
        self.assertTrue(actual_genre.__eq__(database.find_item_by_name(actual_genre.name)))
...
def main():
    genre_from_audio_file_suite = unittest.TestLoader(
    ).loadTestsFromTestCase(GetGenreFromAudioFileTest)
